...
class CreditCardChargesControllerTest < ActionController::TestCase
  ...
  test "should create credit_card_charge" do
    assert_difference('CreditCardCharge.count') do
      post :create, credit_card_charge: { amount: @credit_card_charge.amount, company_id: @credit_card_charge.company_id, paid: @credit_card_charge.paid, refunded: @credit_card_charge.refunded, unique_code: @credit_card_charge.unique_code, user_id: @credit_card_charge.user_id }
    end
  ...
  test "should update credit_card_charge" do
    patch :update, id: @credit_card_charge, credit_card_charge: { amount: @credit_card_charge.amount, company_id: @credit_card_charge.company_id, paid: @credit_card_charge.paid, refunded: @credit_card_charge.refunded, unique_code: @credit_card_charge.unique_code, user_id: @credit_card_charge.user_id }
    assert_redirected_to credit_card_charge_path(assigns(:credit_card_charge))
  end
